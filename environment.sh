...
export LIBXML2_HOME="$PROJECT_HOME/software/libxml2/libxml2/install"

export LD_LIBRARY_PATH="$LIBXML2_HOME/lib:$JASPER_HOME/install/lib:$NETCDF_HOME/lib:$LD_LIBRARY_PATH"
export PATH="$LIBXML2_HOME/bin:$WGRIB_HOME:$CDO_HOME/bin:$NETCDF_HOME/bin:$PATH"
