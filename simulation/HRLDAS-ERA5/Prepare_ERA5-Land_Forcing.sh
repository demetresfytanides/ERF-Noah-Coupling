...
INFILE=${PROJECT_HOME}/simulation/HRLDAS-ERA5/ERA5-Land-Noah-MP-${indate}.grib
predate=${preyear}-${premonth}-${preday}
PREVIOUS_FILE=${PROJECT_HOME}/simulation/HRLDAS-ERA5/ERA5-Land-Noah-MP-${predate}.grib
