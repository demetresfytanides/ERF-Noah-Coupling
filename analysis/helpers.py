...
def load_erf_scm(dpath='.',dt=1.0,Tavg=3600.):
    ...
    try:
        ...
        pltfiles = sorted([dpath for i,dpath in zip(pltsteps,pltfiles)])
        assert len(pltfiles) > 0
        # load column data
